...
%given data.
% input:
%  dataFromClasses - a (number of classes, 1) cell of 
%                    (samples, dimension) data matrices.
% output:
...
%       (1/total number of samples) * sum_i (number of samples in class i) * Si
